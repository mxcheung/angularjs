...
import com.maxcheung.models.DataTableXP;

public class DataTableXPTest {
	...
	public void shouldSerialise() throws Exception {
		DataTableXP dataTable = new DataTableXP();
		...
		cellValue.setCellValue(BigDecimal.TEN.toString());
		
	//	HashBasedTable table = HashBasedTable.create();
		
		table.put(cellValue.getRowKey(), cellValue.getColumnKey(), BigDecimal.TEN.toString());
	...
	//	dataTable.setColumnTotals(table.rowMap().get("rowKey"));
		...
		DataTableXP dataTable2 = mapper.readValue(json, DataTableXP.class);
		dataTable2 = mapper.readValue(json, DataTableXP.class);
